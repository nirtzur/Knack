window.addListeners = function($) {
  ...
  function ajaxCall(action, path, callback, data, errorcall) {
    $.ajax({
      ...
      type: action,
      headers: {
        'X-Knack-Application-Id': ARIZONAHUB_APP_ID,
        'X-Knack-REST-API-Key': ARIZONAHUB_CODE
      },
      data: data,
  ...
  function updateSubRecords(data) {
    ...
    window.location.href = "https://arizonahub.knack.com/database#rehab-budget/pre-property-details/" + preproperty_id + "/view-budget-details/" + new_identifier;
  ...
  $(document).on('knack-view-render.view_313', function(event, view, data) {
    ...
    if (data["field_580_raw"]) {
      ...
      window.location.href = "https://arizonahub.knack.com/database#rehab-budget/pre-property-details/" + data["id"] + "/view-budget-details/" + budget_id;
    }
  });
  ...
  $(document).on('knack-form-submit.view_662', function(event, view, record) {
    ...
    window.location.href = "https://arizonahub.knack.com/database#reports/investor-budget-history-report/?view_642_0_filters=" + filter_string + "&view_642_1_filters=" + filter_string;
    return false;
  });
  ...
  $(document).on('knack-view-render.view_668', function(event, view, data) {
    $('#view_668 input[type=submit]').on("click", function(e) {
      debugger;
      var url = "https://arizonahub.knack.com/database#reports/properties10/"
